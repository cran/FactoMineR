...
# new
#        if (aux2 < aux3) aux4 = phyper(Table[j,k],marge.li[j],sum(marge.li)-marge.li[j],marge.col[k])*2
#        else aux4 = phyper(Table[j,k]+1,marge.li[j],sum(marge.li)-marge.li[j],marge.col[k],lower.tail=FALSE)*2
